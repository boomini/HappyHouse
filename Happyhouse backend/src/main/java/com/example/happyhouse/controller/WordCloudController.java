...
import com.example.happyhouse.model.service.WordService;
...
public class WordCloudController {
	...
	public ResponseEntity<List<WordDto>> interestlistWord() {
		logger.debug("listWord - 호출");
		return new ResponseEntity<>(wordService.interestlistWord(), HttpStatus.OK);
	}
